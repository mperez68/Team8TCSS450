...
public class ChatListViewModel extends AndroidViewModel {
    ...
    /**
     * Integer to reset list to avoid duplications in recycler view.
     */
    private int myAsynchronousCallCount;
...
//        myAsynchronousCallCount.setValue(0);
    ...
    private void handleResult(final JSONObject theResult) {
        //temporary if else to fix recycler duplication issue.
        if (myAsynchronousCallCount == 4) {
            mChatList.setValue(new ArrayList<>());
            myAsynchronousCallCount = 0;
        } else {
            myAsynchronousCallCount++;
        }
