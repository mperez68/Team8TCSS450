 ...
 */
public final class ContactsGenerator {

    private static final edu.uw.tcss450.team8tcss450.ui.contacts.ContactsPost[] BLOGS;
    public static final int COUNT = 20;


    static {
        BLOGS = new edu.uw.tcss450.team8tcss450.ui.contacts.ContactsPost[COUNT];
        for (int i = 0; i < BLOGS.length; i++) {
            BLOGS[i] = new edu.uw.tcss450.team8tcss450.ui.contacts.ContactsPost
    ...
    public static List<edu.uw.tcss450.team8tcss450.ui.contacts.ContactsPost> getContactsList() {
        return Arrays.asList(BLOGS);
    }

    public static edu.uw.tcss450.team8tcss450.ui.contacts.ContactsPost[] getBLOGS() {
