...
//        myAsynchronousCallCount.setValue(0);
    ...
    /**
     * getter for length of chat ID list.
     * @return length of chatid list.
     */
...
//Instantiate the RequestQueue and add the request to the queue
    ...
    /**
     * Sends a GET to the server requesting messages.
     * @param theChatID the chatID.
     * @param theJwt the Json web token.
     */
