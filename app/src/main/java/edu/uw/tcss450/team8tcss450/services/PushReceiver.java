package edu.uw.tcss450.team8tcss450.services;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    public static final String RECEIVED_CONTACT_REQUEST = "contact request from pushy";
...
//    }
    ...
    private void handleContactNotifications(Context context, Intent intent) {
        ActivityManager.RunningAppProcessInfo appProcessInfo = new ActivityManager.RunningAppProcessInfo();
        ActivityManager.getMyMemoryState(appProcessInfo);
        ...
        if (appProcessInfo.importance == IMPORTANCE_FOREGROUND || appProcessInfo.importance == IMPORTANCE_VISIBLE) {
            ...
            //create an Intent to broadcast a message to other parts of the app.
            Intent i = new Intent(RECEIVED_NEW_MESSAGE);
            i.putExtra("contactRequest", "new contact request");
//            i.putExtra("memberid", memberId);
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                    ...
                    .setContentTitle("You have a new contact request")
                    .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                    .setContentIntent(pendingIntent);
